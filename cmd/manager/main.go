...
import (
	...
	"github.com/open-cluster-management/k4e-leaf-hub-status-sync/pkg/controller"
	"github.com/open-cluster-management/k4e-leaf-hub-status-sync/pkg/transport"
	lhSyncService "github.com/open-cluster-management/k4e-leaf-hub-status-sync/pkg/transport/sync-service"
...
const (
	...
	leaderElectionLockName          = "k4e-leaf-hub-status-sync-lock"
)
